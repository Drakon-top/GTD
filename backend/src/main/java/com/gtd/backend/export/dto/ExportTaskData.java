...
@AllArgsConstructor
@Builder
@Schema(description = "Task data in export (with nested subtasks and reminders)")
public class ExportTaskData {
    ...
    @Schema(description = "Recurrence rule as JSON string")
    ...
    @Schema(description = "Nested subtasks")
    private List<ExportTaskData> subtasks;

    @Schema(description = "Reminders attached to this task")
    private List<ExportReminderData> reminders;
