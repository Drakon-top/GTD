...
function DraggableTaskItem({
  ...
  const stampClass = task.isCompleted && theme.taskCompletedStamp ? 'theme-formal-stamp' : task.isCompleted && theme.dragonsForgeStamp ? 'theme-dragons-forge-stamp' : task.isCompleted && theme.iceForgeStamp ? 'theme-ice-dragons-frozen-stamp' : '';
  ...
  return (
    <li ref={setNodeRef} style={style} {...listeners} {...attributes}>
      ...
      >
        ...
        {theme.iceDotIndicator && !task.isCompleted && (
          <span className="theme-ice-dragons-ice-dot mt-1.5 shrink-0" />
        )}
        {theme.taskNumbering && (
